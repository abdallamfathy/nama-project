      ...
      <div className=" mt-6  mx-20 grid  grid-cols-5 justify-end text-white max-sm:m-5 max-sm:flex max-sm:flex-col">
        ...
        <div className="col-span-2 columns-3 flex-col items-end flex ">
          ...
          <div className="grid grid-flow-row  grid-cols-4  relative left-14 row-start-3 ">
            <p className="col-span-3 w-80 relative right-2 text-sm max-sm:right-12 max-sm:text-right">
        ...
        <div className="col-span-1 flex-col items-end flex ">
          ...
          <div className="flex flex-col">
            <div className="flex gap-6 flex-wrap justify-end mb-8  max-sm:flex-col max-sm:items-end">
            ...
            <div className="flex justify-end gap-3 max-sm:pb-5 max-sm:gap-6">
