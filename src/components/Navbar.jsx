          ...
          <div className='flex -mt-2'>
            <form className='mr-4'>   
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block p-4 pr-10 w-[310px] h-[50px] text- indent-48 text-sm text-gray-900 bg-gray-50 rounded-lg border-[#ff73155e] " placeholder="...بحث" required=""/>
