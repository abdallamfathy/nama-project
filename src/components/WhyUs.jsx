...
const WhyUs = () => {
  return (
    <div className="container mx-auto my-20">
      ...
      >
        <SwiperSlide>
          <span className="relative top-16 left-[50px] text-center  p-4 text-white bg-[#3A3535] rounded-3xl">
            مقاوم للملوحة والرطوبة
          </span>
          <span className="relative -top-8 right-8 text-center flex items-center p-5 justify-center text-white bg-[#3A3535] rounded-3xl">
            متوفر بجميع الأشكال
          </span>
          <span className="relative top-4 text-center p-8 justify-center text-white bg-[#3A3535] rounded-3xl">
            خشونة السطح
          </span>
          <span
