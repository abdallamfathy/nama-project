    ...
    <>
      ...
      <div className="container mx-auto">
        ...
        <div className="text-right flex flex-col mb-12">
          ...
          <p className="text-2xl text-[#3A3535]">
            ...
            والجودة لضمان خروج منتج عالى الجودة لتلبية احتياجات عملائنا الكرام
            بالكمية المطلوبة طبقا للجدول الزمنى المتفق عليه مع العميل ويقع مصنع
            نما طيبة للمنحات الاسمنتية بموقع متميز لضمان تغطية أكبر لجميع
            عملائنا ونسعى لفتح فروع أخرى لتلبية احتياجات عملائنا بباقى مناطق
            المملكة{" "}
          </p>
        </div>
        <div className="flex flex-row flex-wrap gap-8 justify-center">
          <div>
            <div className="bg-white text-[#FF7315] z-100 flex justify-center items-center p- w-36 h-20 font-bold text-2xl text-center rounded-xl relative top-8 left-96 shadow-xl">
              <p className="text-center">قيمنا</p>
            </div>
          ...
          <div>
            <div className="bg-white text-[#FF7315] z-100 flex justify-center items-center p- w-36 h-20 font-bold text-2xl text-center rounded-xl relative top-8 left-96 shadow-xl">
              <p className="text-center">أهدافنا</p>
            </div>
            <div className="w-[550px] rounded-2xl p-9 h-72 text-xl bg-[#3A3535] inline-block text-white text-right ">
              <p className="mt-2">
          ...
          <div>
            <div className="bg-white text-[#FF7315] z-100 flex justify-center items-center p- w-36 h-20 font-bold text-2xl text-center rounded-xl relative top-8 left-96 shadow-xl">
              <p className="text-center">سياستنا الخاصة</p>
            </div>
            <div className="w-[550px] rounded-2xl p-9 h-72 text-xl bg-[#3A3535] inline-block text-white text-right">
              <p className="mt-2">
                رضا عملائنا المعيار الوحيد المعتمد لدينا هو رضا العملاء التنمية
                نسعى الى خلق بيئة عمل متجددة داخل المصنع ونهدف الى التحسين
                المستمر للمصنع وللموظفين تحسين نطم الادارة الالتزام والمحافظة
                على العمل وفقا للايزو 9001-2008 ونلتزم بالتطوير المستمر من خلال
                تحليل ملاحظات العملاء والمراجعة.
              </p>
            </div>
          </div>
          <div>
            <div className="bg-white text-[#FF7315] z-100 flex justify-center items-center p- w-36 h-20 font-bold text-2xl text-center rounded-xl relative top-8 left-96 shadow-xl">
              <p className="text-center">رؤيتنا</p>
            </div>
            <div className="w-[550px] rounded-2xl p-9 h-72 text-xl bg-[#3A3535] inline-block text-white text-right ">
              <p className="mt-2">
                التخطيط الناجح والتنفيذ الدقيق والأداء المبتكر والجودة العالية
                والمصداقية الكبيرة, هى رؤيتنا فى عملنا التى تعزز ريادتنا للخدمات
                المتكاملة فى مجال المقاولات العامة مع التزامنا على استداة تنفيذ
                أعمالنا بكل دقة ومهنية واحترافية, مع مراعاة ثقة عملائنا الغالية,
                ونعمل على تقديم أفضل الخدمات لها بكل صدق واخلاص وأمانة.
              </p>
            </div>
          </div>
        </div>
