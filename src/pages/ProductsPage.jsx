  ...
  return (
    ...
    <Navbar textColor="text-[#3A3535] border-b border-[#ff731573]" socialDisplay="hidden"/>
      <div className='container mx-auto'>
          ...
          <h1 className='text-3xl text-[#FF7315]'>منتجاتنا</h1>
...
<a href="#" className=' z-50 '>
  <img className="-my-10 transition duration-[2000]  delay-300 hover:transition-all ease-out hover:left-20 absolute left-24 top-12  hover:w-44  w-36 h-36 hover:h-44   " src={brick1} alt="asd" />
</a>
